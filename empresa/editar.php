...
<div class="container">
    ...
    <div class="col-lg-6 col-md-8 col-centered">
        <div class="well">
            <form id="formEditar">
                <h2 class="form-signin-heading">Editar Empresa</h2>
                <?php
                ...
                while($row = mysqli_fetch_array($result)):?>
                    <input type="text" name="codigo_empresa" id="codigo_empresa" value="<?php echo $codigo_empresa;?>" hidden>
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" class="form-control input-sm" value="<?php echo $row['nombre']?>" id="nombre" name="nombre">
                    </div>
                    <div class="form-group">
                        <label>País</label>
                        <select class="form-control input-sm" name="pais" id="pais"></select>
                        <input type="text" name="codigo_pais" id="codigo_pais" value="<?php echo $row['pais'];?>" hidden="true">
                    </div>
                ...
                <?php endwhile;?>
                <button class="btn btn-lg btn-primary btn-block" type="submit" name="actualizar">Actualizar</button>
            ...
            $('#formEditar').submit(function () {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (resultado==1){
                            $('#alertaEditarSuccess p').text('Empresa Actualizada.');
