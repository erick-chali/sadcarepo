...
<div class="container">
    ...
    <div class="col-lg-6 col-md-8 col-centered">
        <div class="well">
            <form id="formEditar">
                <h2 class="form-signin-heading">Editar País</h2>
                <?php
                ...
                while($row = mysqli_fetch_array($result)):?>
                    <input type="text" name="codigo_pais" id="codigo_pais" value="<?php echo $row['codigo_pais'];?>" hidden>
                    <div class="form-group">
                        <label for="descripcion">Descripci&oacute;n</label>
                        <input type="text" class="form-control input-sm" value="<?php echo $row['descripcion']?>"  id="descripcion" name="descripcion" >
                    </div>
                    <div class="form-group">
            ...
            $('#formEditar').submit(function () {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (resultado==1){
                            $('#alertaEditarSuccess p').text('Pais Actualizado.');
