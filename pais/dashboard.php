...
<div class="container">
    ...
    <table class="table table-bordered table-condensed">
        ...
        while($row = mysqli_fetch_array($result))
        {
            ...
            echo "<td>" . "<a role='button' href='editar.php?id=".$row['codigo_pais']."' class='btn btn-primary btn-xs'>Editar</a>" .
                " <a role='button' href='eliminar.php?id=".$row['codigo_pais']."' class='btn btn-danger btn-xs'>Eliminar</a>".
                "</td>";
            echo "</tr>";
        }
        ?>
